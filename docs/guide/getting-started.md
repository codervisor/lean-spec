...
You can customize this to fit your workflow. See [Configuration Reference](/reference/config) for details.
...
For a complete command reference, see [CLI Commands](/reference/cli).

## What's Next?

Now that you have LeanSpec set up, you can:

- Read the [Quick Start Tutorial](/guide/quick-start) for a hands-on walkthrough
- Learn about [Templates](/guide/templates) to customize your workflow
- Explore [AI Integration](/ai-integration/) to set up AI coding agents
- Understand the [Core Philosophy](/guide/philosophy) behind LeanSpec

## Need Help?

- Check out the [CLI Reference](/reference/cli) for detailed command documentation
- Visit the [GitHub repository](https://github.com/codervisor/lean-spec) to report issues
- Read [Best Practices](/ai-integration/best-practices) for tips on effective spec writing
