...
**When updating specs:**
```bash
lspec update specs/20251102/001-feature --field reviewer=alice --field estimate=large
```
...
lspec update specs/20251102/001-feature --field epic=PROJ-123
...
**Next**: Explore [AI Integration](/ai-integration/) or check the [Configuration Reference](/reference/config).
