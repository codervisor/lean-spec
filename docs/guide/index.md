...
Ready to get started? Head over to the [Getting Started](/guide/getting-started) guide to install LeanSpec and create your first spec.

Want to understand the core principles? Check out [Agile Principles](/guide/principles).

Working with AI coding agents? See [AI Integration](/ai-integration/) for setup guidance.
