...
- **[Templates](/guide/templates)** - Customize spec structure for your workflow
- **[Custom Fields](/guide/custom-fields)** - Add project-specific metadata
- **[AI Integration](/ai-integration/)** - Set up AI coding agents to use your specs
- **[CLI Reference](/reference/cli)** - Learn all available commands
