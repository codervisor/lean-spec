...
See the [AGENTS.md Template](/ai-integration/agents-md) for a complete example.
...
- Read [AGENTS.md Template](/ai-integration/agents-md) for complete template
- Check [Best Practices](/ai-integration/best-practices) for tips
- See [Examples](/ai-integration/examples) for real-world patterns

---

Ready to level up? Explore [Best Practices](/ai-integration/best-practices) next.
