...
If your spec exceeds 300 lines, split it into sub-spec files (`DESIGN.md`, `IMPLEMENTATION.md`, `TESTING.md`, etc.). See [First Principles](/docs/guide/first-principles#1-context-economy) for details.
