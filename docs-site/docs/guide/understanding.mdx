...
:::tip Quick Start
New to LeanSpec? Start with [Terminology](/docs/guide/terminology) to learn essential terms, then return here for the big picture.
:::
...
**Learn more:** [Writing Specs with AI](/docs/guide/usage/ai-assisted/writing-specs-with-ai) covers workflows, patterns, and best practices.
