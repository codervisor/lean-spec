...
**Next**: Learn practical day-to-day techniques in **[The 12 Patterns for AI‑Executable Specs](/docs/guide/ai-executable-patterns)**, or jump to **[When to Use](/docs/guide/when-to-use)** to understand when LeanSpec is the right tool.
