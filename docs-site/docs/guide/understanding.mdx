...
- **Too detailed** → They become outdated quickly
- **Too rigid** → They can't adapt as understanding grows
- **Too formal** → They discourage collaboration

These aren't process failures—they're **constraint violations**. LeanSpec works because it aligns with how humans and AI actually work, not how we wish they worked.
...
1. **Draft initial specs** from human intent and conversation
2. Understand project context quickly
3. Know what needs to be built
4. Recognize boundaries and constraints
5. Generate appropriate code
6. Update specs as work progresses
...
These aren't principles we chose—they're constraints we discovered. LeanSpec works because it aligns with reality: context windows are limited, working memory is small, and time costs money.

If your specs help people (and AI agents) build better software faster, you're doing LeanSpec right.

---

**Next**: Learn practical day-to-day techniques in **[Writing Specs AI Can Execute](/docs/guide/ai-executable-patterns)**, or jump to **[When to Use](/docs/guide/when-to-use)** to understand when LeanSpec is the right tool.
