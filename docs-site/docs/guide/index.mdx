...
- Track project health with Kanban board (`lspec board`) and analytics (`lspec stats`)
- Validate specs for quality and complexity (`lspec validate`)
- Understand dependencies between specs (`lspec deps`)
...
- [Setup guide →](/docs/guide/ai/setup)
...
Want to understand the foundational constraints? Start with [Understanding LeanSpec](/docs/guide/understanding) to see why LeanSpec is designed the way it is.

Need practical execution guidance? Explore [The 12 Patterns for AI‑Executable Specs](/docs/guide/ai-executable-patterns) for day-to-day techniques.

Working with AI coding agents? See [AI Integration](/docs/guide/ai/) for setup guidance.
