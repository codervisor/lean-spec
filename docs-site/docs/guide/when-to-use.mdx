...
> "A one-page spec that gets read beats a fifty-page document that doesn't."

You now understand [what LeanSpec is](/docs/guide/understanding) and [the practical patterns for AI-executable specs](/docs/guide/ai-executable-patterns). This guide helps you decide **when** to apply LeanSpec—and when not to.

LeanSpec is powerful, but it's not always the right tool. This is about judgment, not rules.
...
Remember the [first principles](/docs/guide/understanding): Context Economy, Signal-to-Noise, Intent Over Implementation, Bridge the Gap, Progressive Disclosure. These guide your judgment.

---

**Next**: Explore [Templates](/docs/guide/templates) to customize your workflow, or learn about [AI Integration](/docs/guide/ai/) for AI-powered development.
