...
The CLI package (`lean-spec`) is published to npm. The core package (`@leanspec/core`) is currently workspace-only but can be published if needed for external use.
